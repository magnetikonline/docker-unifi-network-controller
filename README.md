...
```sh
$ docker pull magnetikonline/unifi-network-controller:5.12.66
```
...
$ docker run \
	...
	--rm \
	"magnetikonline/unifi-network-controller:5.12.66"
```
...
Starting server [magnetikonline/unifi-network-controller:5.12.66] as [unifi-network-controller-server]
